...
const MAX_SCROLL = 3000; // Virtual scroll range mapped from GSAP progress
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ScrollTrigger.create({
                trigger: trigger,
                start: "center center",
                end: "+=3000", // The distance the user has to scroll
                pin: true,
                scrub: 1, // Smooth interaction
                onUpdate: (self) => {
                    // Map GSAP progress (0-1) to our Virtual Scroll range
    ...
    return (
        <div ref={triggerRef} className="relative w-full h-[800px] border-y border-white/10 mb-32 overflow-hidden rounded-3xl mx-auto max-w-[95%] bg-[#FAFAFA]">
            {/* Inner Container for content */}
            <div ref={containerRef} className="relative w-full h-full">

                {/* Intro Text (Fades out) */}
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <motion.h1
                ...
                <motion.div
                    ...
                    className="absolute top-[10%] left-0 w-full z-10 flex flex-col items-center justify-center text-center pointer-events-none px-4"
                >
